...
import BarcodeScanner from './BarcodeScanner'; // Make sure to import the scanner
import { 
  UpdateBolBarcodes, 
  getOrders, 
  getLabels, 
...
export default function BolSyncPage() {
  ...
  const getRowStyle = (currentOrder, index) => {
    ...
    if ((prevOrder && currentOrder.orderId === prevOrder.orderId) || 
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center justify-between">
                          <div className="text-sm text-gray-500">
                            <div className=''>
                              <h2><strong>{order.s_firstName} {order.s_surname}</strong></h2>
                          ...
                          <div className="flex items-center justify-center min-w-[80px]">
                            <div className={`text-4xl mr-5 font-bold rounded-lg px-3 py-2 text-center ${
                            ...
                            <div className={`text-4xl font-bold rounded-lg px-3 py-2 text-center ${
                              order.s_countryCode === 'NL' 
                                ? 'text-orange-600 bg-orange-100' 
                                : order.s_countryCode === 'BE' 
                                ? 'text-green-600 bg-green-100' 
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        {editingBarcode === order.orderItemId ? (
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              startEdit(order.orderItemId, label?.Barcode || '');
                            }}
